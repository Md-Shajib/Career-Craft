    ...
    return (
        <div className="border border-gray-300 p-7 text-left rounded-md w-full bg-gray-50">
            ...
            <div>
                ...
                <Link to={`/details/${id}`}><button className="py-2 px-4 rounded-md text-white tracking-wider font-bold bg-gradient-to-r from-[#7e90fe] to-[#9873ff]">View Details</button></Link>
            </div>
        </div>
    );
};
